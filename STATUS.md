...
- `HARDENING-TODO.md` is the temporary operator handoff for validating the promoted image pair, completing one standard publication, and closing this hardening work.
...
- Validate the newly labeled emulator pair, then run one standard publication to seed a reusable artifact and exercise deployment.
