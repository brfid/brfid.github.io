...
# Phase 2 with Chaosnet: VAX + IMPs + PDP-10/ITS with Chaosnet bridge
# This topology adds a Chaosnet shim for ITS-native networking
PHASE2_CHAOSNET_TOPOLOGY = TopologyDefinition(
    name="phase2-chaosnet",
    subnet="172.20.0.0/16",
    gateway="172.20.0.1",
    hosts={
        "vax": HostConfig(
        ...
        "chaosnet-shim": HostConfig(
            name="chaosnet-shim",
            component_type="shim",
            hostname="chaosnet-bridge",
            ...
            dockerfile="./arpanet/Dockerfile.chaosnet-shim",
            depends_on=["pdp10"],
        ),
    },
)
...
TOPOLOGIES = {
    ...
    "phase2-chaosnet": PHASE2_CHAOSNET_TOPOLOGY,
}
