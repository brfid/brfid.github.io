# How to Write a Neurolinguistic Virus v0.1
...
1. [How to Write a Neurolinguistic Virus v0.1](#how-to-write-a-neurolinguistic-virus-v01)
   1. [How Did Essay Assignments Get So Terrible?](#how-did-essay-assignments-get-so-terrible)
   2. [Write Essays Differently](#write-essays-differently)
   3. [Know your mark.](#know-your-mark)
   4. [Demarcate your original contributions with citations](#demarcate-your-original-contributions-with-citations)
   5. [Structure your paper with headings](#structure-your-paper-with-headings)
   6. [Reject Passive Voice and Embrace Causality](#reject-passive-voice-and-embrace-causality)
   7. [Do not make general claims that you did not earn](#do-not-make-general-claims-that-you-did-not-earn)
   8. [Don't Write Summaries That Can Be Replaced By An Algorithm](#dont-write-summaries-that-can-be-replaced-by-an-algorithm)
   9. [Use Sources that are Appropriate to Your Intellect and Education](#use-sources-that-are-appropriate-to-your-intellect-and-education)
...
## Write Essays Differently

My answer to "why essays" is a bit different than Graham's and English professors. An essay is about manipulation of your audience. A well-crafted essay will change someone's thinking, their brain, and later on, possibly their behavior. Fellow CAL professor Alex Wellerstein calls the essay a _neurolingustic virus_, after the concept as introduced in the classic sci-fi novel *[Snow Crash](https://en.wikipedia.org/wiki/Snow_Crash)*. Here, _essays are are a program that is transmitted with language and executes in someone's head._
...
How to you explain where your original analysis lies? You cite everything else. Pick a citation style that will be useful to you in other fields. For our class, we will use the IEEE Style. You can automate the process of collecting references and citing them in documents with software such as [Zotero](https://zotero.org/).

## Structure your paper with headings
...
## Reject Passive Voice and Embrace Causality

Consider these three statements:

1. After TCP was introduced, the Internet had a default mechanism for ordered packet delivery.
2. After DARPA-funded engineers implemented TCP at a handful of Arpanet sites, the Internet had a default mechanism for ordered packet delivery.
3. By implementing TCP at a handful of Arpanet sites, DARPA-funded engineers provided a default mechanism for ordered packet delivery.
...
## Do not make general claims that you did not earn
...
## Don't Write Summaries That Can Be Replaced By An Algorithm
...
## Use Sources that are Appropriate to Your Intellect and Education

If you use a source, you are claiming one of two things:

1. This offers a stronger empirical and/or analytical base than I am capable of providing (e.g. as a secondary source);
2. This is an example of a phenomenon I am studying (e.g. as a primary source).

Which is it?

Some context: One of the major reasons we have cars and thermodynamics and hammers is because we can encode, store, and transmit our knowledge beyond a single individual's life. But what would have happened if we'd passed on all the *garbage*? The dumb ideas, the failed experiments? What if our cultural transmission mechanism had no error correction mechanism, no fault tolerance, pure [GIGO](https://en.wikipedia.org/wiki/Garbage_in,_garbage_out)? No cars, thermodynamics, or hammers--that's for sure. Newton credited his achievements with his ability to 'stand on the shoulders of giants', to draw on the best of what others had accomplished before him. *And we are all considerably less intelligent than Newton.*

The easiest way to ensure that your cultural transmission channels have some kind of functioning error correction is to use *peer-reviewed* sources whenever possible. Check [scholar.google.com](https://scholar.google.com/) as the easiest way to find them. *Peer-reviewed* means that the source went through an institutionalized quality control process, where it was blindly reviewed by experts in the field. Large organizations, such as university presses (e.g. MIT Press, University of California Press), will often have an error correction process that differs from peer review but still utilizes an anonymous, distributed system. If you aren't sure, ask your professor (it's their job).
...
## Explain Your Project as a Response to Others' Failings
