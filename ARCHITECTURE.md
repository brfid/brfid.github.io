...
## Vintage pipeline (pexpect-based, in progress)
...
- Status: implementation in progress (Stage A first)
...
- Status: planned after A and B work independently

### Key constraints

- PDP-11 SIMH console exits if no client connects within ~60 seconds of boot.
